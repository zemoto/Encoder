namespace Encoder.Filters.Video.Denoise
{
   ...
   internal sealed class DenoiseVideoFilterViewModel : FilterViewModel
   {
      ...
      [FilterPropertyDescription( "Threshold 0A", "0a", 0, 0.3 )]
      public double ZeroA
      {
         get => _zeroA;
      ...
      [FilterPropertyDescription( "Threshold 0B", "0b", 0, 5 )]
      public double ZeroB
      {
         get => _zeroB;
      ...
      [FilterPropertyDescription( "Threshold 1A", "1a", 0, 0.3 )]
      public double OneA
      {
         get => _oneA;
      ...
      [FilterPropertyDescription( "Threshold 1B", "1b", 0, 5 )]
      public double OneB
      {
         get => _oneB;
      ...
      [FilterPropertyDescription( "Threshold 2A", "2a", 0, 0.3 )]
      public double TwoA
      {
         get => _twoA;
      ...
      [FilterPropertyDescription( "Threshold 2B", "2b", 0, 5 )]
      public double TwoB
      {
         get => _twoB;
      ...
      [FilterPropertyDescription( "Frames To Average", "s", 5, 129 )]
